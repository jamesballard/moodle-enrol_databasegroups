...
/**
 * Strings for component 'enrol_databasegroups', language 'en'.
 *
...
$string['pluginname'] = 'External database (with groups)';
...
$string['remotegroupfield_desc'] = 'The name of the field in the remote table that we are using to match entries in the group table.';
